...
// admin sign-in (see admin/layout.tsx), but only roles with the "categories"
// scope may see anything under /admin/categories. A staff member without this
