...
import { CHEFS_CTA } from "@/lib/chefs-content";

const EASE: [number, number, number, number] = [0.22, 1, 0.36, 1];

/**
 * src/components/chefs/MenuCTA.tsx
 *
 * Figma Frame 2147236008 — পাতার শেষ ডাক:
 * column, padding 100px 80px, gap 60, BG সাদা, সব মাঝবরাবর।
 *
...
export default function MenuCTA({
  title = CHEFS_CTA.title,
  description = CHEFS_CTA.description,
  buttonLabel = CHEFS_CTA.buttonLabel,
  href = CHEFS_CTA.href,
}: {
  title?: string;
  description?: string;
    ...
    <section className="bg-white px-4 py-16 md:px-10 md:py-20 xl:px-20 xl:py-[100px]">
      ...
      >
        ...
        >
          ...
          {/* Frame 2147235619: সাদা গোল 44px, ভেতরে তীর। */}
          <span
            aria-hidden="true"
