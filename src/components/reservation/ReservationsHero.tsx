...
/**
 * src/components/reservation/ReservationsHero.tsx
 *
 * Figma "Web/Reservation" → Frame 2147235230। `ReservationHero`-র
 * হুবহু একই গড়ন, শুধু লেখা আলাদা — তাই মাপ/ওজন/breakpoint নিয়ে
 * ব্যাখ্যা ওখানেই আছে, এখানে নকল করা হয়নি।
 */
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-4">
        ...
        >
          <h1 className="text-center font-frank-ruhl text-[32px] font-medium leading-[1.1] tracking-[-0.01em] text-black md:text-[44px] lg:text-[56px] xl:text-[72px] xl:leading-none">
            Manage Your Table Reservations with Complete Ease
          </h1>

          <p className="max-w-[782px] text-center font-sora text-[14px] font-normal leading-[1.6] text-black/70 md:text-[16px] xl:text-[18px]">
            View your upcoming bookings, reschedule your visit, or cancel your reservation in just
            a few clicks. Stay in control of every dining experience.
          </p>
        </motion.div>
      </div>
    </section>
