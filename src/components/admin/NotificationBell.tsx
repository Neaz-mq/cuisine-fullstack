...
export default function NotificationBell({
  ...
  return (
    <button
      ...
      /**
       * ⚠️ ৩৯০px-এর নিচে ৩২px, তার উপরে ৫০ — Figma-র মোবাইল frame
       * (৩২০px) ধরে। বিস্তারিত AdminTopbar.tsx-এর header-এর মন্তব্যে;
       * সেখানে পুরো bar-টার প্রস্থের হিসাব লেখা আছে।
       */
      className="relative h-8 w-8 min-[390px]:h-[50px] min-[390px]:w-[50px] shrink-0 flex items-center justify-center rounded-full bg-[#F9F6F3] hover:bg-black/[0.06] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2C6252]/30"
